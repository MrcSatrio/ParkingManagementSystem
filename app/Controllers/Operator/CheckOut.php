...
class CheckOut extends BaseController
{
    ...
    {
        $nomimal_transaksi = $this->request->getVar('nominal_transaksi');
            ...
            if ($user_parking['saldo'] <= $nomimal_transaksi) {
                ...
                $this->transaksiModel->save(
                    [
                        ...
                        'nominal_transaksi' => $nomimal_transaksi,
                        'saldoakhir_transaksi' => $user_parking['saldo'] - $nomimal_transaksi,
                ...
                $this->kartuModel->save(
                    [
                        ...
                        'saldo' => $user_parking['saldo'] - $nomimal_transaksi
                    ]
                );
